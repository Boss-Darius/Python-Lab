    ...
    def PossibleMoves(self):
        ...
        if col > 1:
            ...
            if row != 7 and chessboard[8 * (7 - (row + 1)) + col - 2].occupied == False:
                ...
                if row != 7 and self.CanCapture(row + 1, col - 2): possiblemoves += [chessboard[8 * (7 - (row + 1)) + col - 2]]
            # left down
            if row != 0 and chessboard[8 * (7 - (row - 1)) + col - 2].occupied == False:
                ...
                # capture the piece that is on that field
                if row != 0 and self.CanCapture(row - 1, col - 2): possiblemoves += [chessboard[8 * (7 - (row - 1)) + col - 2]]
        ...
        if row > 1:
            ...
            if col != 0 and chessboard[8 * (7 - (row - 2)) + col - 1].occupied == False:
                ...
                # capture the piece that is on that field
                if col != 0 and self.CanCapture(row - 2, col - 1): possiblemoves += [chessboard[8 * (7 - (row - 2)) + col - 1]]
            # up right
            if col != 7 and chessboard[8 * (7 - (row - 2)) + col + 1].occupied == False:
                ...
                # capture the piece that is on that field
                if col != 7 and self.CanCapture(row - 2, col + 1): possiblemoves += [chessboard[8 * (7 - (row - 2)) + col + 1]]
